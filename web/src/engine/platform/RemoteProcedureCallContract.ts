...
import CustomRemoteProcedureCallContract from './custom/RemoteProcedureCallContract';
...
export function CreateRemoteProcedureCallContract(): IRemoteProcedureCallContract {
    return new PlatformInstanceActivator<IRemoteProcedureCallContract>()
        ...
        .Configure(Runtime.Gecko, () => new CustomRemoteProcedureCallContract(GetIPC()))
        .Configure(Runtime.Chrome, () => new CustomRemoteProcedureCallContract(GetIPC()))
        .Create();
}